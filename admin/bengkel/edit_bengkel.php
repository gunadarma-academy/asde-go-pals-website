            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
						...
						if(isset($_GET['id'])) {
							$idbengkel = $_GET['id'];
							$getbengkel = "SELECT * FROM bengkel WHERE id_bengkel='$idbengkel'";
						...
						<?php
							...
							if( !empty($bengkel_name) && !empty($vehicle_type) && !empty($brand) && !empty($address) && !empty($latitude) && !empty($longitude) ){
								$query = "UPDATE bengkel SET bengkel_name='$bengkel_name', vehicle_type='$vehicle_type', brand='$brand', bengkel_address='$address', telephone='$telephone', latitude='$latitude', longitude='$longitude' WHERE id_bengkel='$id_bengkel'";
								...
								if($result){
									...
									echo '</script>';
									?>
									<meta http-equiv="refresh" content="0; url=bengkel_data.php">
								<?php	
								}
							}
