            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
						...
						if(isset($_GET['id'])) {
							$idspbu = $_GET['id'];
							$getspbu = "SELECT * FROM spbu WHERE id_spbu='$idspbu'";
						...
						<?php
							...
							if( !empty($spbu_name) && !empty($company) && !empty($address) && !empty($latitude) && !empty($longitude) ){
								$query = "UPDATE spbu SET spbu_name='$spbu_name', company='$company', spbu_address='$address', latitude='$latitude', longitude='$longitude' WHERE id_spbu='$id_spbu'";
